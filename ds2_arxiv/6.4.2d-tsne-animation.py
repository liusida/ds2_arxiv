...
topic_sim = np.load("shared/topic_similarity_matrix_tfidf.npy")
...
def tsne(perplexity, learning_rate, run, verbose=False, visual_check=False):
    ...
    ret = TSNE(n_components=2, perplexity=perplexity, learning_rate=learning_rate, n_iter=3000, verbose=verbose).fit(topic_sim)
